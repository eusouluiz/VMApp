...
export var USUARIO_DATA: Usuario[] = [
  new Usuario({ user_id: '9a8b41aa-1fab-4be5-a047-4759d0ce1a4f', nome: 'Admin', cpf: '00000000000', telefone: '041000000000', tipo: 'F' }),
  new Usuario({ user_id: '1', nome: 'Gabriel Falavinha Gomes', cpf: '12345678900', telefone: '041987654321', tipo: 'R' }),
  new Usuario({ user_id: '2', nome: 'Luiz Gustavo Nascimento', cpf: '98765432100', telefone: '041123456789', tipo: 'R' }),
  new Usuario({ user_id: '3', nome: 'Giacomo Vaz', cpf: '08918011970', telefone: '041988222527', tipo: 'F' }),
  new Usuario({ user_id: '4', nome: 'Maria Eduarda Almeida', cpf: '00011122233', telefone: '041999666333', tipo: 'F' }),
  new Usuario({ user_id: '5', nome: 'Ana Vitoria Oliveira', cpf: '55555555555', telefone: '041555555555', tipo: 'A' }),
];

export var TURMA_DATA: Turma[] = [
  new Turma({ turma_id: '0', nome: 'Turma A Manha', descricao: '', updated_at: new Date(), created_at: new Date()}),
  new Turma({ turma_id: '1', nome: 'Turma B Manha', descricao: '', updated_at: new Date(), created_at: new Date()}),
  new Turma({ turma_id: '2', nome: 'Turma A Tarde', descricao: '', updated_at: new Date(), created_at: new Date()}),
];

export var ALUNO_DATA: Aluno[] = [
  new Aluno({ aluno_id: '0', nome: 'Luizinho a0', cgm: '123456789012345', turma_id: TURMA_DATA[0].turma_id, updated_at: new Date(), created_at: new Date() }),
  new Aluno({ aluno_id: '1', nome: 'Gabrielzinho a1', cgm: '123456789012345', turma_id: TURMA_DATA[0].turma_id, updated_at: new Date(), created_at: new Date() }),
  new Aluno({ aluno_id: '2', nome: 'Rafaelzinho a2', cgm: '123456789012345', turma_id: TURMA_DATA[0].turma_id, updated_at: new Date(), created_at: new Date() }),
  new Aluno({ aluno_id: '3', nome: 'Jaiminho a3', cgm: '123456789012345', turma_id: TURMA_DATA[2].turma_id, updated_at: new Date(), created_at: new Date() }),
  new Aluno({ aluno_id: '4', nome: 'Felipinho a4', cgm: '123456789012345', turma_id: TURMA_DATA[2].turma_id, updated_at: new Date(), created_at: new Date() }),
];

export var RESPONSAVEL_DATA: Responsavel[] = [
  new Responsavel({ responsavel_id: '0', user_id: USUARIO_DATA[1].user_id, updated_at: new Date(), created_at: new Date() }),
  new Responsavel({ responsavel_id: '1', user_id: USUARIO_DATA[2].user_id, updated_at: new Date(), created_at: new Date() }),
  new Responsavel({ responsavel_id: '2', user_id: USUARIO_DATA[4].user_id, updated_at: new Date(), created_at: new Date() }),
];

export var FUNCIONALIDADE_DATA: Funcionalidade[] = [
  new Funcionalidade({ funcionalidade_id: '0', nome: 'Gerenciamento Responsaveis', descricao: 'Gerencia todos os responsaveis', updated_at: new Date(), created_at: new Date() }),
  new Funcionalidade({ funcionalidade_id: '1', nome: 'Gerenciamento Aluno', descricao: 'Gerencia todos os alunos', updated_at: new Date(), created_at: new Date() }),
  new Funcionalidade({ funcionalidade_id: '2', nome: 'Gerenciamento Turma', descricao: 'Gerencia todas as turmas', updated_at: new Date(), created_at: new Date() }),
  new Funcionalidade({ funcionalidade_id: '3', nome: 'Gerenciamento Funcionarios', descricao: 'Gerencia todos os funcionarios', updated_at: new Date(), created_at: new Date() }),
  new Funcionalidade({ funcionalidade_id: '4', nome: 'Gerenciamento Cargo', descricao: 'Gerencia todos os cargos', updated_at: new Date(), created_at: new Date() }),
  new Funcionalidade({ funcionalidade_id: '5', nome: 'Gerenciamento Canal', descricao: 'Gerencia todos os canais', updated_at: new Date(), created_at: new Date() }),
  new Funcionalidade({ funcionalidade_id: '6', nome: 'Gerenciamento Aviso', descricao: 'Gerencia todos os avisos', updated_at: new Date(), created_at: new Date() }),
];

export var CARGO_DATA: Cargo[] = [
  new Cargo({ cargo_id: '9a9f8804-94e5-4f5e-a0e5-d44b67731b0f', nome: 'Admin', descricao: '', updated_at: new Date(), created_at: new Date()}, undefined, FUNCIONALIDADE_DATA),
  new Cargo({ cargo_id: '1', nome: 'Funcionarios - Responsavel', descricao: '', updated_at: new Date(), created_at: new Date()}),
  new Cargo({ cargo_id: '2', nome: 'Funcionarios - Funcionario', descricao: '', updated_at: new Date(), created_at: new Date()}),
];

export var FUNCIONARIO_DATA: Funcionario[] = [
  new Funcionario({ funcionario_id: '0', user_id: USUARIO_DATA[0].user_id, cargo_id: CARGO_DATA[0].cargo_id, updated_at: new Date(), created_at: new Date() }),
  new Funcionario({ funcionario_id: '1', user_id: USUARIO_DATA[3].user_id, cargo_id: CARGO_DATA[1].cargo_id, updated_at: new Date(), created_at: new Date() }),
  new Funcionario({ funcionario_id: '2', user_id: USUARIO_DATA[4].user_id, cargo_id: CARGO_DATA[2].cargo_id, updated_at: new Date(), created_at: new Date() }),
  new Funcionario({ funcionario_id: '3', user_id: USUARIO_DATA[5].user_id, cargo_id: CARGO_DATA[2].cargo_id, updated_at: new Date(), created_at: new Date() }),
];

export var CANAL_DATA: Canal[] = [
  new Canal({ canal_id: '0', nome: 'Admin c0', descricao: '', updated_at: new Date(), created_at: new Date() }, [CARGO_DATA[0]]),
  new Canal({ canal_id: '1', nome: 'Secretaria c1', descricao: '', updated_at: new Date(), created_at: new Date() }),
  new Canal({ canal_id: '2', nome: 'Pedagogia c2', descricao: '', updated_at: new Date(), created_at: new Date() }),
